...
import com.bizzan.bitrade.util.HmacSHA256Signer;
import com.bizzan.bitrade.util.HttpRequestUtil;
...
public class OpenApiInterceptor implements HandlerInterceptor {
    ...
    public static void main(String[] args)throws Exception {
        ...
        Map map = new TreeMap();
//        map.put("memberId","9");
        String sin = createSignature("get","/open-api/user/get/account","cdgs9k03f3-9230e45d-5bf1d983-fe287",timeStamp,map,"3d53b8ea-4ea4d893-8f27a188-9648a");
        ...
        String ss = HttpRequestUtil.URLGet("https://api.yoobi.world/open-api/user/get/account",params,"utf-8");
