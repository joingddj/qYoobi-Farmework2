    ...
    public void syncUsdtCnyPrice() throws UnirestException {
        ...
        if(resp.getStatus() == 200) { //正确返回
	        ...
	        if(ret.getIntValue("code") == 0) {
	        	...
	        	if(result!=null&&result.containsKey("buy")){
        ...
        String url2 = "https://otc-api.eiijo.cn/v1/data/trade-market?coinId=2&currency=1&tradeType=sell&currPage=1&payMethod=0&country=37&blockType=general&online=1&range=0&amount=";
